...
if __name__ == "__main__":
    ...
    # Display results list of tuples (topods_shape, label, color)
    display, start_display, add_menu, add_function_to_menu = init_display()

    filename = "/home/doug/step-files/as1-oc-214.stp"
    output_shapes = read_step_file_with_names_colors(filename)
    # output_shapes is a dict -> {<class 'TopoDS_Solid'>: ['l-bracket', <class 'Quantity_Color'>], ...}
    for shape, [label, color] in output_shapes.items():
